          ...
          <table className="bg-white w-3/4 text-xl border-separate border-spacing-3 text-center">
            <tbody>
              ...
              <tr>
                ...
                <td className="border w-2/4 border-black">2.7 Kwh</td>
              </tr>
              <tr>
                <td className="border w-2/4 border-black">
                  Max Range (@30km/h)
                </td>
                <td className="border w-2/4 border-black">150 km</td>
              </tr>
              <tr>
                <td className="border w-2/4 border-black">Charging Time</td>
                <td className="border w-2/4 border-black">4 hours (12A)</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="border w-2/4 border-black">55 km/h</td>
              </tr>
              <tr>
                <td className="border w-2/4 border-black">
              ...
              <tr>
                ...
                <td className="border w-2/4 border-black">110 km</td>
              </tr>
              <tr>
                <td className="border w-2/4 border-black">
                  Other Key Benefits
